    ...
    a = {
      ...
      1162: function (e, t, r) {
                  ...
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        ...
                        case 8:
                          return (
                            (o = e.sent), (e.prev = 9), (e.next = 12), o.json()
                          );
                        case 12:
                          (o = e.sent), (e.next = 18);
                          break;
        ...
        (window.gform.config = window.gform.config || {}),
          (window.gform.config = u(u({}, window.gform.config), {
            getConfig: s,
            updateConfig: m,
            cleanPath: l,
            getConfigViaAjax: f,
      ...
      3953: function (e, t, r) {
        ...
        var w = "save-continue",
                ...
                return c().wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (r = i.length > 1 && void 0 !== i[1] ? i[1] : _),
                          (n = i.length > 2 && void 0 !== i[2] ? i[2] : j),
                          (e.next = 4),
                          (0, u.filter)({
                        ...
                        (a = o.displayConfirmation),
                          o.submissionMethod !== n &&
                            (n = B(t, o.submissionMethod)
                              ...
                              : n),
                          (e.t0 = r),
                          (e.next = e.t0 === y ? 13 : e.t0 === w ? 15 : 18);
                        break;
                      case 13:
                        return U(t), e.abrupt("break", 18);
                      case 15:
                        return (
                          ((0, u.getNode)(
          ...
          E = function (e) {
            var t = (0, o.A)(
                (0, o.A)(
                  (0, o.A)(
                    (0, o.A)((0, o.A)({}, w, "gform_save_link"), v, ""),
                    h,
                    "gform_next_button"
                  ),
                  y,
            ...
            if ("gform_send_resume_link_button" === e.name) return v;
            for (
        ...
        (t.Ay = function (e) {
          ...
          (window.gform.submission = p(
            p({}, window.gform.submission || {}),
            {},
            {
              handleButtonClick: O,
              submitForm: S,
              ...
              lockSubmission: D,
              unlockSubmission: F,
              SUBMISSION_TYPE_SUBMIT: _,
              SUBMISSION_TYPE_NEXT: h,
              SUBMISSION_TYPE_PREVIOUS: y,
              SUBMISSION_TYPE_SAVE_AND_CONTINUE: w,
              SUBMISSION_TYPE_SEND_LINK: v,
              SUBMISSION_METHOD_IFRAME: x,
              SUBMISSION_METHOD_POSTBACK: j,
      ...
      9143: function (e, t, r) {
        ...
        var n = r(8079),
                    ...
                    switch ((e.prev = e.next)) {
                      ...
                      case 15:
                        return (
                          ...
                          (u = !1),
                          o.data.page_markup
                            ? (_(t, n, o.data.page_number, o.data.page_markup),
                              o.data.page_number > 0 &&
                                o.data.page_number !==
                                  o.data.source_page_number &&
                                h(t, n, o.data.page_number),
                              (0, s.Uy)(),
                              (u = !0))
                            : o.data.form_markup
                            ? (((0, c.getNode)(
                      ...
                      case 20:
                        return (
                          (d = e.sent),
                          (o = d.submissionResult),
                          p(t),
                          u && (0, f.A)(t, o.data.page_number),
                          e.abrupt("return", o)
                        );
                      case 25:
                      case "end":
          ...
          g = (function () {
            var e = (0, o.A)(
              i().mark(function e(t, r, o) {
                var a, c, u, s, f, d, l, p, g;
                return i().wrap(
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            (a = new URL(m().common.form.ajax.ajaxurl)),
                            (c = a.pathname + a.search),
                            (e.next = 4),
                            fetch(c, { method: "POST", body: y(t, r, o) })
                          );
                        case 4:
                          return (
                            (u = e.sent),
                        ...
                        case 9:
                          (f = e.sent),
                            (d = f.split("\x3c!-- gf:json_start --\x3e")),
                            (l = d[1].split("\x3c!-- gf:json_end --\x3e")),
                            (p = (0, n.A)(l, 1)),
                            (g = p[0]),
                            (s = JSON.parse(g.trim())),
                            (e.next = 18);
                          break;
                        case 15:
                          (e.prev = 15), (e.t0 = e.catch(6)), (s.success = !1);
                        case 18:
                          return (
                            s.success ||
                              (s.data =
                                s.data ||
                                m().common.form.ajax.i18n.unknown_error),
                            e.abrupt("return", s)
                          );
                        case 20:
                        case "end":
                    ...
                    switch ((e.prev = e.next)) {
                      ...
                      case 6:
                        return (
                          ...
                          (u = o.getAttribute("data-form-theme")),
                          (f = (0, c.getNode)("#gform_".concat(t), o, !0)) &&
                            f.reset(),
                          (e.next = 13),
                          k(n.confirmation_markup)
                        );
                      case 13:
                        (o.outerHTML = e.sent),
                          (o = (0, c.getNode)(
                            ...
                            o.setAttribute("data-form-theme", u)),
                          w(t),
                          (0, s.Ui)(t);
                      case 18:
                      case "end":
                    ...
                    switch ((e.prev = e.next)) {
                      ...
                      case 4:
                        (n.innerHTML = e.sent),
                          ...
                          (f = (0, c.getNode)(".gform_heading", a, !0)),
                          a.insertBefore(n.firstChild, f),
                          (0, s.Uy)();
                      case 11:
                      case "end":
                        return e.stop();
                ...
                return i().wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (
                          (o = (0, c.getNodes)(".gform_page", !0, r, !0)) &&
                          0 !== o.length
                        ) {
                          e.next = 3;
                          break;
          ...
          y = function (e, t, r) {
            ...
            return (
              o &&
                (n.append(
                  "display_title",
                  (0, c.getNode)(".gform_title", o, !0) ? 1 : 0
                ),
                n.append(
                  "display_description",
                  (0, c.getNode)(".gform_description", o, !0) ? 1 : 0
                )),
              n
            );
          },
      ...
      9942: function (e, t, r) {
        ...
        (window.gform.config = window.gform.config || {}),
          (window.gform.config.isValid = w);
        r(2590);
        var v = function () {
            s(),
              p(),
              document.addEventListener("gform/post_render", function (e) {
                _(e.detail.formId, e.detail.currentPage);
              }),
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        ...
                        return (e.next = 5), r.e(157).then(r.bind(r, 3445));
                      case 5:
  ...
  (c.m = a),
    ...
    (c.u = function (e) {
      return (
        ...
        "." +
        {
          145: "0dfb7385e843d0466264",
          157: "c8d66b5f8124a2af8d42",
          567: "587d4d6a27e3ce97f03d",
          952: "719da8c71caeabb8f415",
        }[e] +
        ".min.js"
      );
    }),
