        ...
        function o() {
          ...
          function p(t, e, n, r) {
            var o = e && e.prototype instanceof b ? e : b,
              ...
              a = new C(r || []);
            return c(i, "_invoke", { value: T(t, n, a) }), i;
          }
          function h(t, e, n) {
            try {
          ...
          var A = Object.getPrototypeOf,
            j = A && A(A(P([])));
          j && j !== i && a.call(j, l) && (S = j);
          var E = (O.prototype = b.prototype = Object.create(S));
          function k(t) {
          ...
          function T(t, n, r) {
            ...
            return function (i, a) {
              ...
              for (r.method = i, r.arg = a; ; ) {
                ...
                var l = h(t, n, r);
                if ("normal" === l.type) {
                  if (((o = r.done ? y : g), l.arg === w)) continue;
          ...
          return (
            ...
            c(O, "constructor", { value: x, configurable: !0 }),
            (x.displayName = d(O, f, "GeneratorFunction")),
            ...
            (n.mark = function (t) {
              return (
                Object.setPrototypeOf
                  ...
                  : ((t.__proto__ = O), d(t, f, "GeneratorFunction")),
            ...
            (C.prototype = {
              ...
              finish: function (t) {
                for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                  ...
                  if (n.finallyLoc === t)
                    return this.complete(n.completion, n.afterLoc), I(n), w;
                }
              },
              catch: function (t) {
                for (var e = this.tryEntries.length - 1; e >= 0; --e) {
    ...
    (function () {
      ...
      var F = function (t) {
          ...
          if (Array.isArray(t)) {
            var n = [];
            e.set(t, n);
            for (var r = 0; r < t.length; r++) n[r] = F(t[r], e);
            return n;
          }
          if (t instanceof Map) {
            var o = new Map();
      ...
      var ct = function (t, e) {
          ...
          for (var o = 0, i = n; o < i.length; o++) {
            var a = i[o];
            if (!r.includes(a) || !ct(t[a], e[a])) return !1;
          }
          return !0;
        },
        ut = ct;
      ...
      var mt = function (t, e, n, r) {
          if (
            ...
            (!yt(o, i) && r) || Object.defineProperty(t, n, i);
          }
        },
        yt = function (t, e) {
          return (
        ...
        xt = Object.getOwnPropertyDescriptor(Function.prototype, "toString"),
        ...
        St = function (t, e, n) {
          var r = "" === n ? "" : "with ".concat(n.trim(), "() "),
            o = bt.bind(null, r, e.toString());
          Object.defineProperty(o, "name", Ot),
            Object.defineProperty(
              t,
              "toString",
              gt(gt({}, xt), {}, { value: o })
      ...
      function It() {
        ...
        if (i && Lt.includes(i)) {
          var h = zt[i],
            v = h.normalizeIdentifier(r);
          if (h.handleValidationRegex && h.handleValidationRegex.test(v))
            return (
              (n.identifier = v),
              h.finalizeIdentifier &&
                (n.identifier = h.finalizeIdentifier(n.identifier, !0)),
              (n.url = h.urlTemplate(n.identifier, null)),
              (n.platform = i),
              (n.valid = !0),
              n
            );
        ...
        return (function (t, e) {
          ...
          for (r = 0; r < d; r++)
            if ("string" == typeof t[r]) p += t[r];
              ...
              if (
                (Nt.not_type.test(i.type) &&
                  Nt.not_primitive.test(i.type) &&
                  n instanceof Function &&
                  (n = n()),
                Nt.numeric_arg.test(i.type) && "number" != typeof n && isNaN(n))
              )
                throw new TypeError(
                  $t("[sprintf] expecting number but found %T", n)
                );
              switch ((Nt.number.test(i.type) && (l = n >= 0), i.type)) {
                case "b":
              ...
              Nt.json.test(i.type)
                ? (p += n)
                : (!Nt.number.test(i.type) || (l && !i.sign)
                    ? (s = "")
                    : ((s = l ? "+" : "-"),
                      (n = n.toString().replace(Nt.sign, ""))),
                  (c = i.pad_char
                    ? "0" === i.pad_char
                      ? "0"
                      : i.pad_char.charAt(1)
          ...
          (function (t) {
            ...
            var e,
              ...
              o = 0;
            for (; n; ) {
              if (null !== (e = Nt.text.exec(n))) r.push(e[0]);
              else if (null !== (e = Nt.modulo.exec(n))) r.push("%");
              else {
                if (null === (e = Nt.placeholder.exec(n)))
                ...
                if (e[2]) {
                  ...
                  var i = [],
                    a = e[2],
                    c = [];
                  if (null === (c = Nt.key.exec(a)))
                    throw new SyntaxError(
                      "[sprintf] failed to parse named argument key"
                    );
                  for (i.push(c[1]); "" !== (a = a.substring(c[0].length)); )
                    if (null !== (c = Nt.key_access.exec(a))) i.push(c[1]);
                    else {
                      if (null === (c = Nt.index_access.exec(a)))
                        throw new SyntaxError(
                          "[sprintf] failed to parse named argument key"
                        );
                      i.push(c[1]);
      ...
      function Dt(t, e) {
        return $t.apply(null, [t].concat(e || []));
      }
      ...
      var Vt = function () {
              ...
              m = (function (t, e) {
                ...
                return (
                  (void 0 === m
                    ...
                    .forEach(function (t) {
                      "fadeIn" === t &&
                        ((c.opacity = h || 0), (u.opacity = g || 1)),
                        "fadeOut" === t &&
                          ((c.opacity = h || 1), (u.opacity = g || 0)),
                        "translateY" === t &&
              ...
              setTimeout(function () {
                u(),
                  requestAnimationFrame(function () {
                    r.animate(m, { duration: Number(h), easing: g }).onfinish =
                      function () {
                        !(function (t, e) {
                          var n,
                            r,
        ...
        Bt = !!window.chrome,
        Gt = "undefined" != typeof InstallTrigger,
        Yt = document.documentMode || !1,
        Xt = !Yt && !!window.StyleMedia,
        Kt = !!window.navigator.userAgent.match(/(iPod|iPhone|iPad)/i),
        Qt = !!window.navigator.userAgent.match(/(iPod|iPhone)/i),
        te = !!window.opera || window.navigator.userAgent.indexOf(" OPR/") >= 0,
        ee =
          Object.prototype.toString
            .call(window.HTMLElement)
            .indexOf("Constructor") > 0 ||
          (!Bt && !te && "undefined" !== window.webkitAudioContext),
        ne = window.navigator.platform;
      function re() {
        return {
          android: Jt,
          chrome: Bt,
      ...
      function le() {
        ...
        if (
          ...
          try {
            ...
            return _("Copy to clipboard failed.", t), !1;
          } finally {
        ...
        t.addEventListener("mousedown", function (n) {
          ...
          t.addEventListener("mouseup", function () {
            (e.isDown = !1),
              ...
              se({ event: "gform-utils/horizontal-drag-ended", native: !1 }),
      ...
      var Ie = function (t) {
          ...
          n.instances &&
            t &&
            ge("[data-simplebar]", !0, t, !0).forEach(function (t) {
              var e;
        ...
        Fe = function (t) {
          Pe[t].up &&
            (window.cancelAnimationFrame(Pe[t].up), (Pe[t].up = null)),
            Pe[t].down &&
              (window.cancelAnimationFrame(Pe[t].down), (Pe[t].down = null));
        },
        Ne = function (t, e) {
          var n =
              arguments.length > 2 && void 0 !== arguments[2]
        ...
        $e = function (t, e) {
          var n =
            ...
            o = t.offsetHeight,
            i = null;
          (t.style.maxHeight = "".concat(o, "px")), Re(e), Fe(e);
          var a = function (c) {
            i || (i = c);
            var u = c - i,
              l = Me(u / n) * (0 - o) + o;
      ...
      if ("undefined" != typeof Element && !Element.prototype.matches) {
        ...
        Ge.matches =
          Ge.matchesSelector ||
          Ge.mozMatchesSelector ||
          Ge.msMatchesSelector ||
          Ge.oMatchesSelector ||
          Ge.webkitMatchesSelector;
      }
      function Ye(t, e, n, r, o) {
        var i = Xe.apply(this, arguments);
        return (
      ...
      var Ke = function (t, e, n, r) {
        ...
        return "function" == typeof t.addEventListener
          ...
          : "function" == typeof n
          ? Ye.bind(null, document).apply(null, arguments)
      ...
      var nn = window.gform.instances.filters,
        rn = (function () {
          var t,
            e =
              ((t = en().mark(function t() {
                var e,
                  n,
                  r,
                  o,
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        ...
                        (n = nn[e.event]).sort(function (t, e) {
        ...
        an = function (t, e) {
          ...
          void 0 === nn[t] && (nn[t] = []);
          var o = t + "_" + nn[t].length;
          nn[t].push({ tag: o, callable: e, priority: n, isAsync: r });
        },
        cn = function (t) {
          var e =
              arguments.length > 1 && void 0 !== arguments[1]
            ...
            n =
              arguments.length > 2 && void 0 !== arguments[2]
                ...
                : null;
          if (void 0 !== nn[t])
            for (var r = nn[t], o = r.length - 1; o >= 0; o--)
              (null !== n && n !== r[o].tag) ||
        ...
        var t =
          ...
          e =
            arguments.length > 1 && void 0 !== arguments[1]
              ...
              : 200;
        !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2]
          ? window.addEventListener("resize", Be(t, { wait: e }))
          : window.removeEventListener("resize", Be(t, { wait: e }));
      }
      var sn = {},
        fn = function (t) {
        ...
        dn = function (t) {
          ...
          return (
            void 0 === sn[e] && (sn[e] = !1),
            function () {
              sn[e] || ((sn[e] = !0), t.apply(this, arguments));
            }
          );
        };
      function pn() {
