  ...
  "function" != typeof ElementsKit_Helper.swiper &&
    (ElementsKit_Helper.swiper = function (e, t) {
      ...
      if ("function" != typeof Swiper) {
        return new (0, elementorFrontend.utils.swiper)(i, t).then((e) => e);
      }
      {
        const e = new Swiper(i, t);
  ...
  let i = {
    init: function () {
      var n = {
        ...
        "elementskit-circle-menu.default": i.Circle_Menu,
        "elementskit-advanced-search.default": i.Advanced_Search,
      };
      ...
      e(t)
        ...
        .each(function () {
          e(this).click(() => {
            ...
            !0 === e(this).data("collapsed")
              ? (e(t).text(e(this).data("text")), e(this).text("...Collapse"))
              : (e(t).text(e(this).data("text").substr(0, 120)),
                e(this).text("...More")),
    ...
    Advanced_Accordion: function (t) {
      t.find(".elementskit-card > .collapse")
        .on("shown.bs.collapse", function () {
          var n = e(this);
          n.is(".elementskit-card > .collapse") && n.css({ height: "auto" }),
            i.WidgetAreaJSUpdate.call(n),
            ElementsKit_Helper.ajaxLoading(t, n);
        })
        .filter(".show")
    ...
    Advanced_Toggle: function (t) {
        ...
        function l(e, t) {
          ...
          s.attr(
            ...
            "elemenetskit-toggle-indicator " +
              t.parents("li").data("elementor_current_item")
          ),
            s.css({ width: i, height: n, left: a, top: l });
        }
        l(null, o),
      ...
      a.on("click", function () {
        var t = this.checked
          ? ".elementskit-switch-nav-link-2"
          : ".elementskit-switch-nav-link-1";
        e(this).siblings(t).tab("show");
      }),
        n
          .on("shown.bs.tab", function () {
            var n = t.find(e(this).attr("href"));
            a.length && (a[0].checked = this.getAttribute("data-toggled")),
              i.WidgetAreaJSUpdate.call(n),
              ElementsKit_Helper.ajaxLoading(t, n);
          })
          .filter(".active")
    ...
    Advanced_Tab: function (n) {
      var a = n.find('[data-ekit-toggle="tab"]'),
        ...
        o = n.data("settings");
      t.isEditMode() &&
        (o = t.config.elements.data[n.data("model-cid")].attributes),
      ...
      i.imagesLoaded(function () {
        ...
        t
          ...
          .on("click", function (t) {
            t.preventDefault();
            var n = e(this);
            n.parents(".option-set").find(".selected").removeClass("selected"),
              n.addClass("selected"),
              i.isotope({ filter: n.data("option-value") });
          });
      ...
      if (i.hasClass("ekit_char_based")) {
        ...
        e.each(a, function (e, t) {
          (l +=
            " " === t
              ? t
              : '<span class="ekit-letter" style="animation-delay: ' +
                s +
    ...
    PopupModal: function (e) {
      ...
      var c = e.find(
          ".ekit-popup-modal__toggler-wrapper button, .ekit-popup-modal__toggler-wrapper img"
        ),
        p = e.find(
          ".ekit-popup__close, .ekit-popup-modal__close, .ekit-popup-footer__close"
        );
    ...
    Unfold: function (t) {
      var i = t.find(".ekit-unfold-btn"),
        ...
        o = n.data("config");
      o.collapse_height >= s.outerHeight()
        ? (i.hide(), a.addClass("active"))
        : (i.show(), a.removeClass("active")),
          ...
          (t.style.display = "none"),
            a.hasClass("active")
              ? (a.animate(
                  ...
                  parseInt(o.transition_duration, 10) || 0
                ),
                i.html(
                  ElementsKit_Helper.removeSpecificCharacters(o.expand_text)
                ))
              : (a.animate(
                ...
                i.html(
                  ElementsKit_Helper.removeSpecificCharacters(o.collapse_text)
                )),
    ...
    Mini_Cart: function (t) {
      ...
      i.on("click mouseenter mouseleave", function (t) {
        ...
        "click" === t.type &&
        n &&
        !e(t.target).parents("div").hasClass("ekit-mini-cart-container")
          ? s.fadeToggle()
          : "mouseenter" === t.type && a
          ? s.fadeIn()
          : "mouseleave" === t.type && a && s.fadeOut();
      }),
        t
          .find(
            ".ekit-mini-cart--backdrop, .ekit-dropdown-back > i, .ekit-dropdown-back > .ekit-basket-item-count"
          )
          .on("click", function () {
    ...
    Table: function (i) {
      ...
      if (
        (t.isEditMode() &&
          (n = t.config.elements.data[i.data("model-cid")].attributes),
        i.find(".ekit_table").length > 0)
      ) {
        var a = i.find(".ekit_table").data("settings"),
          s =
            "text" === a.nav_style.trim() || "both" === a.nav_style.trim()
              ? '<span class="ekit-tbl-pagi-nav ekit-tbl-pagi-prev">' +
                a.prev_text +
                "</span>"
              : "",
          o =
            "text" === a.nav_style.trim() || "both" === a.nav_style.trim()
              ? '<span class="ekit-tbl-pagi-nav ekit-tbl-pagi-next">' +
                a.next_text +
                "</span>"
              : "",
          l =
            "arrow" === a.nav_style.trim() || "both" === a.nav_style.trim()
              ? '<i class="ekit-tbl-pagi-nav-icon ekit-tbl-pagi-nav-prev-icon ' +
                a.prev_arrow +
                '" aria-hidden="true"></i>'
              : "",
          r =
            "arrow" === a.nav_style.trim() || "both" === a.nav_style.trim()
              ? '<i class="ekit-tbl-pagi-nav-icon ekit-tbl-pagi-nav-next-icon ' +
                a.next_arrow +
                '" aria-hidden="true"></i>'
              : "";
        e(window).trigger("resize");
        var d = a.item_per_page ? a.item_per_page : 10,
          c = {
            ...
            language: {
              ...
              info: n.info_text,
              infoEmpty: n.info_text
                ? n.info_text.replace(/_START_|_END_|_TOTAL_/gi, "0")
                : "",
        ...
        !1 === a.entries && (c.dom = "Bfrtip");
        const t = i.find(".ekit_table table"),
          p = t.find("tbody tr:first td").length,
          f = t.find("thead tr");
        if (f.length) {
          for (let e = f.children("th").length; e < p; e++)
            f.append("<th></th>");
        }
        t.DataTable(c);
      }
    ...
    TimeLine: function (t) {
      ...
      let i = null;
      t.find(".horizantal-timeline > .single-timeline").hasClass("hover") ||
        t
          .find(".horizantal-timeline > .single-timeline")
          .first()
          .addClass("hover")
          .siblings()
          .removeClass("hover"),
        t
          ...
          .on(
            ...
            ".horizantal-timeline > .single-timeline",
            function () {
              e(this).removeClass("hover"), i && i.addClass("hover");
            }
          );
    },
    ...
    Hotspot: function (t) {
      var i = t.find(
          ".ekit-location-on-click > .ekit-location_indicator, .ekit-location-on-hover.click > .ekit-location_indicator"
        ),
        n = t.find(
          ".ekit-location-on-hover:not(.click) > .ekit-location_indicator"
        ),
      ...
      function s() {
        let t = e(this).find(".ekit-location_outer"),
          ...
          n =
            i.width() / 2 +
            e(this).find(".ekit-hotspot-vertical-line").height(),
          a =
            i.width() + e(this).find(".ekit-hotspot-horizontal-line").height(),
          s = i.width() + e(this).find(".ekit-hotspot-horizontal-line").width();
        if (!t.length) return;
        let o = (function (e) {
            const t = window.innerWidth;
            let i = e.parents(".ekit-location-groups").data("breakpoints");
            if (void 0 !== i)
              return t <= i.mobile
                ? "mobile"
                : t <= i.tablet
          ...
          l = e(this).data("directions");
        if (
          (l &&
            (e(this).removeClass(function (e, t) {
              return (t.match(/ekit_hotspot_follow_line_\w+/g) || []).join(" ");
            }),
            l?.[o]
              ? e(this).addClass(`${l[o]}`)
              : e(this).addClass(`${l?.desktop}`)),
          e(this).hasClass("ekit_hotspot_follow_line_top")
            ...
            : e(this).hasClass("ekit_hotspot_follow_line_right_top") ||
              e(this).hasClass("ekit_hotspot_follow_line_left_top")
            ? t.css("bottom", n)
            : e(this).hasClass("ekit_hotspot_follow_line_right_bottom") ||
              e(this).hasClass("ekit_hotspot_follow_line_left_bottom")
            ? t.css("top", n)
            : e(this).hasClass("ekit_hotspot_follow_line_right")
            ? (t.css("top", -(t.height() / 2 - i.width() / 2)),
              t.css("left", s))
            : e(this).hasClass("ekit_hotspot_follow_line_left") &&
              (t.css("top", -(t.height() / 2 - i.width() / 2)),
              t.css("right", s)),
          t.offset().left < 0)
        )
          e(window).width() <= 480 &&
            ...
            e(this)
              .find(".ekit-location_outer")
              .css("margin-left", Math.abs(t.offset().left));
          ...
          if (e(window).width() <= 480 && t.width() > e(window).width())
            e(this)
              ...
              e(this)
                .find(".ekit-location_outer")
                .css("left", -Math.abs(t.offset().left));
      ...
      e(window).load(function () {
        ...
        e(window).width() <= 480 &&
          ...
          a
            .removeClass("hotspot-following-line-style")
            .addClass(
              "hotspot-following-line-straight ekit_hotspot_follow_line_top"
            )),
          t.find(".ekit-location_outer").each(function () {
            e(this).offset().top < 0 &&
              e(this).parents(".ekit-location-on-hover").addClass("bottom"),
              e(this).parent().hasClass("auto") &&
                e(this).offset().top < 0 &&
                e(this)
                  .parent()
                  .removeClass("ekit_hotspot_follow_line_top")
                  .addClass("ekit_hotspot_follow_line_bottom");
          }),
          setTimeout(function () {
            a.each(s);
          }, 1e3),
        ...
        i.on("click", function () {
          t.find(".ekit-all-activated").length ||
            e(this).parent().siblings().removeClass("active"),
            e(this)
              .parent()
              .toggleClass("active")
              .removeClass("ekit-all-activated");
        }),
    ...
    Vertical_Menu: function (t) {
      if (t.find(".ekit-vertical-main-menu-on-click").length > 0) {
        ...
        ("tablet" !== a && "mobile" !== a) ||
          i.removeClass("vertical-menu-active"),
                ...
                : e(window)
                    .bind("resize", function () {
                      e(document).width() > 1024
                        ? i.css({
                            width:
                              Math.floor(n.width() - a.width() - 10) + "px",
                          })
                        : i.removeAttr("style");
                    })
                    .trigger("resize")
      ...
      t.find(".megamenu-ajax-load").length > 0 &&
        t
          .find(".ekit-vertical-main-menu-wraper")
    ...
    Video_Gallery: function (i) {
      var n = i.find(".video-link.popup"),
        ...
        s =
          (i.find(".ekit-video-gallery-wrapper.ekit-masonry"),
          i.find(".elementskit-main-filter>li>a")),
      ...
      if (
        (n.length > 0 &&
          n.magnificPopup({
            ...
            iframe: {
              markup:
                '<div class="mfp-iframe-scaler"><div class="mfp-close ekit-popup-close"></div><iframe class="mfp-iframe" frameborder="0" allow="autoplay"></iframe></div>',
              patterns: {
                youtube: {
                  index: "youtube.com/",
                  id: "v=",
        ...
        a.on("click", function (t) {
          ...
          e(this)
            ...
            .append(
              '<iframe src="' +
                i +
                '" width="643" height="360" allow="autoplay" frameborder="0"></iframe>'
            ),
            r(e(this).find("iframe"), 10);
        }),
        s.on("click", function (t) {
          t.preventDefault();
          var n = e(this).data("value") ? "." + e(this).data("value") : "";
          i.find("a").removeClass("selected"),
            e(this).addClass("selected"),
            i.find(".ekit-video-item").hide(),
            i.find(".ekit-video-item" + n).fadeIn();
        }),
        o.length)
      ) {
        l.arrows &&
      ...
      const r = (t, i = 100) => {
        setTimeout(function () {
          var i = t,
            n = i[0].contentDocument || i[0].contentWindow.document;
          n &&
            e(n)
              .find("video")
    ...
    Facebook_Review: function (e) {
      i.Social_Review_Slider(e.find(".ekit-review-slider-wrapper-facebook")),
        i.Handle_Review_More(e);
    },
    Yelp_Review: function (e) {
      i.Social_Review_Slider(e.find(".ekit-review-slider-wrapper-yelp")),
        i.Handle_Review_More(e);
    },
    BlogPosts: function (i) {
      ...
      if (
        (i.on(
          "click",
          ".ekit-blog-post-pagination-container a.page-numbers",
          function (t) {
            t.preventDefault();
            ...
            e.ajax({ url: a }).done(function (t) {
              ...
              "loadmore" == n.data("ekit-blog-post-style")
                ? i.find(s.items).append(o)
                : i.find(s.items).html(o),
                i.find(s.nagivation).html(l),
                e(o).imagesLoaded(function () {
                  var t = e(s.items);
                  t.data("masonry")
                    ? (t.masonry("reloadItems"), t.masonry("layout"))
                    : t.masonry({
    ...
    Advanced_Slider: function (i) {
      ...
      var l = {
              ...
              "yes" === o?.sliderOptions.sliderThumbsShow &&
                (function () {
                  let { sliderOptions: t } = o,
                    ...
                    s = a.children(),
                    l = t.sliderTabItems.map(
                      (e) => e.ekit_slider_thumbs_image.url
                    ),
                    r = s.length,
                    d = { display: "grid" };
                  s.each(function (t) {
                    ...
                    i.css({
                      ...
                      i.siblings().css({ width: "100%" });
                  }),
                    "horizontal" === t.sliderDirectionType
                      ? ((d.width = t.sliderThumbsOffset.size
                          ? `${t.sliderThumbsOffset.size}%`
                          : "70%"),
                        (d.gridTemplateColumns = `repeat(${r}, 1fr)`),
                        (d.gridTemplateRows = "1fr"),
                        (d.marginTop = "7px"))
                      : ((d.gridTemplateColumns = "1fr"),
                        (d.gridTemplateRows = `repeat(${r}, 1fr)`));
        ...
        navigation: {
          nextEl: a.length
            ? a.find(".ekit-double-btn-two")
            : i.find(".swiper-button-next").get(0),
          prevEl: a.length
            ? a.find(".ekit-double-btn-one")
            : i.find(".swiper-button-prev").get(0),
        },
      };
      "horizontal" == o.sliderOptions.sliderDirectionType
        ? ((l.slidesPerView = o.sliderOptions.slidesPerViewItem),
          (l.spaceBetween = o.sliderOptions.spaceBetweenGap),
          (l.breakpoints = o.sliderOptions.breakpointsOption))
        : (l.slidesPerView = 1),
        ("yes" != o.sliderOptions.sliderAutoPlay &&
        ...
        "yes" == o.sliderOptions.sliderMouseScroll &&
          (l.mousewheel = { invert: !0, sensitivity: 1, thresholdTime: 9 });
      ...
      function d(t) {
        ...
        e(t.slides[i])
          ...
          .each(function (t, i) {
            let { _animation: n, _animation_delay: a } =
              e(i).data("settings") || {};
            n &&
              (e(i)
                .addClass("animated elementor-invisible")
                .css({ "animation-name": "unset" }),
              setTimeout(() => {
                e(i).css({ "animation-name": n }),
      ...
      function c(t) {
        ...
        n.find(".ekit-swiper-wrapper, .ekit-swiper-slide").css({ height: a }),
          t.update();
      }
      ElementsKit_Helper.swiper(r, l).then(function (e) {}),
        "yes" == o.sliderOptions.progressBar &&
          (i
            .find(".ekit-slider-wrapper, .ekit-swiper-progress")
            .each(function (t, i) {
              e(i).on("mouseenter", function () {
                o?.sliderOptions?.pauseOnMouseEnter &&
                  s.css({ animationPlayState: "paused" });
              });
            }),
          i
            .find(".ekit-slider-wrapper, .ekit-swiper-progress")
    ...
    Whatsapp: function (e) {
      const t = e.find(".elementskit-whatsapp__popup--btn"),
        ...
        u = ({ url: e, title: t, w: i, h: n }) => {
          ...
          window.open(
            e,
            t,
            `scrollbars=yes, width=${i / r}, height=${
              n / r
            }, top=${c}, left=${d}`
          );
        };
      "show" == l.data("show") && (l.addClass(c), d.length > 0 && p()),
        ...
        n.on("click", function () {
          f(),
            "popup" == s && u({ url: a, title: "popup", w: 700, h: 600 }),
            i.val("");
        }),
        i.keypress(function (e) {
          13 == e.which &&
            ...
            "_self" == s
              ...
              : "_blank" == s
              ? window.open(a)
              : u({ url: a, title: "popup", w: 700, h: 600 }),
            i.val(""));
        }),
        o.length > 0 &&
          "popup" == o.attr("target") &&
        ...
        function h(e, t) {
          e.parents(".ekit-fancy-text").hasClass("type")
            ...
            : e.parents(".ekit-fancy-text").hasClass("clip") &&
              e
                .parents(".ekit-fancy-text-lists")
                .animate({ width: e.outerWidth() + 0 }, c, function () {
                  setTimeout(function () {
                    u(e);
                  }, p);
                });
    ...
    Image_Morphing: function (e) {
      let i,
        ...
        l = e.data("settings");
      t.isEditMode() &&
        (l = t.config.elements.data[e.data("model-cid")].attributes);
      const r = {
        targets: o,
        d: [{ value: s || [] }],
        easing: l.ekit_morphing_effect ? l.ekit_morphing_effect : "easeOutQuad",
        direction: l.ekit_morphing_direction
          ? l.ekit_morphing_direction
          : "alternate",
      ...
      anime(r),
        l.ekit_svg_path_position_scale != undefined &&
          ((i = l.ekit_svg_path_position_scale.size
            ? l.ekit_svg_path_position_scale.size
            : "1"),
          (n = l.ekit_svg_path_position_translate_x.size
            ? l.ekit_svg_path_position_translate_x.size + "px"
            : "100px"),
          (a = l.ekit_svg_path_position_translate_y.size
            ? l.ekit_svg_path_position_translate_y.size + "px"
            : "100px"),
          e
    ...
    Image_Swap: function (t) {
      ...
      i.click(function () {
        ...
        "click-inactive" == n &&
          i.click(function () {
            e(this).hasClass("click-inactive")
              ? e(this).removeClass("click-inactive").addClass("click-active")
              : e(this).addClass("click-inactive").removeClass("click-active");
          });
    },
    Content_Ticker: function (i) {
      ...
      if ("marquee" !== o) {
        var l = {
          loop: !0,
          speed: s.settingOptions.tickerSpeed
            ? "typing" === o
              ? 100
              : 1e3 * s.settingOptions.tickerSpeed
            : 1e3,
          slidesPerView: "auto",
          direction: s.settingOptions.tickerDirection
            ? s.settingOptions.tickerDirection
            : "horizontal",
        ...
        function r(e) {
          if ("vertical" === s.settingOptions.tickerDirection) {
            ...
            n
              .find(".ekit-marquee .swiper-wrapper, .ekit-marquee-item")
              .css("height", `${i}px`),
              e.update();
          }
        }
        function d(t) {
          if ("typing" === o) {
            ...
            !(function l() {
              o < a.length &&
                ((n[0].innerHTML += a.charAt(o)),
                o++,
                setTimeout(l, (s.settingOptions.tickerDelay - 3e3) / a.length));
            })();
          }
        }
      ...
      if ("marquee" === o) {
        let p = i.find(".ticker"),
          ...
          u = f.clone(!0);
        "yes" === s.settingOptions.tickerReverseDirection
          ? p.addClass("ticker-right")
          : p.addClass("ticker-left"),
          p.css({ "padding-left": "100%" }),
          f.css({ "padding-right": "100%" }),
          "yes" !== s.settingOptions.tickerGapBetween &&
            (p.append(u),
            "yes" === s.settingOptions.tickerReverseDirection
              ? p.addClass("ticker-right-loop")
              : p.addClass("ticker-left-loop"),
    ...
    Coupon_Code: function (t) {
      ...
      i.magnificPopup({
        ...
        callbacks: {
          beforeOpen: function () {
            this.st.mainClass =
              "my-mfp-slide-bottom ekit-promo-popup ekit-coupon-popup ekit-coupon-modal";
          },
        },
      }),
        ...
        e(n).on("click", function () {
          ...
          e(i).removeClass("slide-hide"),
            "click" == n && e(t).addClass("slide-hide");
        }),
          ...
          e(this).addClass("active"),
            ...
            (o = setTimeout(() => {
              e(this).removeClass("active"),
                e(this).next(".ekit_after_copied_text").removeClass("active");
            }, 2e3));
        }),
        t.find(".ekit_coupon_copybtn").on("click", function (i) {
          ...
          e(this)
            .find(".ekit_coupon_btn_group_wrap .ekit_copybtn_text")
            .text(`${n}`),
            o && clearTimeout(o),
            (o = setTimeout(() => {
              e(this)
    ...
    Comparison_Table: function (t) {
      t.find("#buttonId").click(function () {
        var i = t.find(
            ".ekit-comparison-table-body a, .ekit-comparison-table-body li"
          ),
          n = {};
        i.each(function () {
          var t = e(this).text();
    ...
    Interactive_Links: function (t) {
      ...
      function a() {
        t.find(".ekit-interactive-links-list-link-title-container").each(
          function (t, i) {
            let n = e(i),
              a = n.data("image");
            n.closest(".ekit-interactive-active").length
      ...
      i.eq(0).addClass("ekit-interactive-active"),
        ...
        i.mouseenter(function () {
          e(this).hasClass("ekit-interactive-active") ||
            (e(this)
              .addClass("ekit-interactive-active")
              .siblings()
              .removeClass("ekit-interactive-active"),
            n
              .removeClass("ekit-interactive-active")
              .eq(e(this).index())
              .addClass("ekit-interactive-active"),
            n
              .removeClass("ekit-interactive-next")
              .eq(e(this).index())
              .next()
              .addClass("ekit-interactive-next"),
            n
              .removeClass("ekit-interactive-prev")
              .eq(e(this).index())
              .prev()
              .addClass("ekit-interactive-prev"),
            t
              .find(".ekit-interactive-special")
              .addClass("ekit-interactive-prev"),
            a());
        }),
        i.mouseout(function () {
          n.removeClass("ekit-interactive-special")
            .eq(e(this).index())
            .addClass("ekit-interactive-special");
        }),
        a();
    },
    Circle_Menu: function (e) {
      let t = e.find(".ekit-circle-menu-wrapper").data("settings");
      e.find(".ekit-circle-menu-box").circleMenu({
        direction: t.menuDirection,
        item_diameter: t.menuDiameter.size,
        circle_radius: t.menuRadius.size,
        speed: t.menuSpeed.size,
        delay: t.menuDelay.size,
        step_out: t.menuStepOut.size,
        step_in: t.menuStepIn.size,
        trigger: t.menuTrigger,
        transition_function: t.menuTransition,
      });
    },
    Advanced_Search: function (t) {
      const i = t.find(".ekit-advanced-search-wrapper"),
        n = i.find("form"),
        a = n.attr("action"),
        s = n.data("settings"),
        o = n.find(".ekit-search"),
        l = i.find(".ekit-advanced-search-result"),
        r = l.find(".ekit-search-result-items"),
        d = n.find(".ekit-search .ekit-adv-search-closer"),
        c = n.find(".ekit-search .ekit-adv-search-loader"),
        p = n.find(".search-field"),
        f = l.find(".ekit-search-load-more-button > a"),
        u = l.find(".ekit-popular-keyword"),
        h = i.find(".ekit-advanced-search-result.after-popular-keyword");
      function m() {
        t.find(".select").each(function () {
          const t = e(this),
            i = t.find(".select-trigger"),
            n = t.find(".select-dropdown"),
            a = t.find(".select-option"),
            s = t.find(".selected-text"),
            o = t.find('input[type="hidden"]');
          function l() {
            n.css({ maxHeight: "0", visibility: "hidden", opacity: "0" }),
              t.removeClass("open");
          }
          i.on("click", function () {
            t.hasClass("open")
            ...
            a.on("click", function () {
              const t = e(this);
              s.text(t.text()), o.val(t.data("value")), l(), v();
            });
        });
      }
      function k() {
        e(".ekit-keyword-list").on("click", ".ekit-keyword", function (t) {
          t.preventDefault(), p.val(e(this).data("keyword")), v();
        });
      }
      function g() {
        d.css({ display: "none" }), l.hide(), h.show(), u.show();
      }
      function v() {
        if (!p.val()) return;
        const t = { formData: n.serialize() },
          i = { ...s, ...t };
        e.ajax({
          type: "POST",
          url: a,
          ...
          dataType: "html",
          beforeSend: function () {
            c.css({ display: "inline-flex" }), d.css({ display: "none" });
          },
          success: function (t) {
            !(function (t) {
              const i = e(t),
                n = i.data("posts-count"),
                a = i.data("search-found");
              s.keywordOff || r.css({ paddingTop: "12px" });
              l.show(),
                h.hide(),
                r.html(t),
                n > s.postsPerPage ? f.show() : f.hide();
              a !== undefined
                ? (u.hide(), r.css({ display: "flex" }))
                : r.css({ display: "" });
            })(t);
          },
          complete: function () {
      ...
      m(),
        e(window).on("mouseup", function (t) {
          e(t.target).closest(i).length || g();
        }),
        k(),
        (function () {
          if ("click-expand" === s.styleSelect) {
            const e = n.find(".ekit-submit .ekit-search-button"),
              t = e.find(".ekit-search-icon"),
              i = e.find(".ekit-close-icon");
            o.hide(),
              e.on("click", function (e) {
                e.preventDefault(),
                  o.toggleClass("s-show"),
                  o.hasClass("s-show")
                    ? (t.hide(), i.show(), o.show())
                    : (t.show(), i.hide(), o.hide());
              });
          }
        })(),
        s.styleSelect,
        n.on("input submit", function (e) {
          e.preventDefault(), v();
        }),
        f.on("click", function (e) {
          e.preventDefault(), (s.postsPerPage += 5), v();
        });
    },
  };
