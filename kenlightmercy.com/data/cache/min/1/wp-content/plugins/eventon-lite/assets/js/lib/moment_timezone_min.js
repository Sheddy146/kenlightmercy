!(function (a, i) {
  ...
  function E() {
    for (
      ...
      (r = new Date(e, n, 1).getTimezoneOffset()) !== c &&
        ((a = (function (a, i) {
          for (var r; (r = 6e4 * (((i.at - a.at) / 12e4) | 0)); )
            (r = new h(new Date(a.at + r))).offset === a.offset
              ...
              : (i = r);
          return a;
        })(o, (i = new h(new Date(e, n, 1))))),
        A.push(a),
        A.push(new h(new Date(a.at + 6e4))),
        (o = i),
        (c = r));
    for (n = 0; n < 4; n++)
      A.push(new h(new Date(e + n, 0, 1))),
        A.push(new h(new Date(e + n, 6, 1)));
    return A;
  }
  function g(a, i) {
  ...
  function z() {
    ...
    for (
      var r,
        ...
        A = (function (a) {
          for (
            var i, r, e, o = a.length, c = {}, A = [], n = {}, t = 0;
            t < o;
            t++
          )
            if (((r = a[t].offset), !n.hasOwnProperty(r))) {
              for (i in (e = m[r] || {})) e.hasOwnProperty(i) && (c[i] = !0);
              n[r] = !0;
            }
          for (t in c) c.hasOwnProperty(t) && A.push(u[t]);
          return A;
        })(o),
        n = [],
        t = 0;
  ...
  function T(a, i) {
    ...
    return r instanceof M
      ...
      ? ((r = new M(r)), (s[a] = r))
      : c[a] && i !== T && (i = T(c[a], T))
      ? ((r = s[a] = new M())._set(i), (r.name = u[a]), r)
      : null;
  }
  function S(a) {
    var i, r, e, o;
  ...
  function y(a) {
    ...
    return (
      !o.isMoment(a) && B(i) && (a = T(r)) && i.add(a.parse(i), "minutes"),
      i.tz(r),
      i
    );
  }
